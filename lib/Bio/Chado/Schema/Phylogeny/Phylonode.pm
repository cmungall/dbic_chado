...
These relationships supplement or alias the autogenerated relations above.

=head2 child_phylonodes

Type: has_many

Related object: L<Bio::Chado::Schema::Phylogeny::Phylonode>

Get all children of this phylonode, at any degree of separation.
...
__PACKAGE__->has_many(
    'children',
    __PACKAGE__,
    [ { 'foreign.left_idx'  => { '>' => 'self.left_idx'  }},
      { 'foreign.right_idx' => { '<' => 'self.right_idx' }},
    ],
    { cascade_copy => 0, cascade_delete => 0 },
);

=head2 parent_phylonodes

Type: has_many

Related object: L<Bio::Chado::Schema::Phylogeny::Phylonode>

Get all parents of this phylonode, at any degree of separation.
...
Direct parent of this Phylonode.  Alias for the autogenerated
L</parent_phylonode> relationship.

=cut

{ no warnings 'once'; *parent = \&parent_phylonode }
...
Direct children of this Phylonode.  Alias for the autogenerated
L</phylonodes>.
...
{ no warnings 'once';
  *children        = \&phylonodes;
  *children_rs     = \&phylonodes_rs;
  *add_to_children = \&add_to_phylonodes;
}
...
All of the child nodes of this phylonode, at any degree of
separation.
...
All of the parent nodes of this phylonode, at any degree of
separation.
