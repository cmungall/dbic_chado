package Chado::Schema::Library::LibraryCvterm;
...
__PACKAGE__->add_unique_constraint("library_cvterm_pkey", ["library_cvterm_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uJEyY7ranooqR14w53FijA
