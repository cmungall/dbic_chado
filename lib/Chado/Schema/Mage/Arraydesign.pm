package Chado::Schema::Mage::Arraydesign;
...
__PACKAGE__->add_unique_constraint("arraydesign_pkey", ["arraydesign_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GbBvv+dwyLElEcQ75F3IZw
