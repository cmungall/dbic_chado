package Chado::Schema::Phylogeny::Phylonodeprop;
...
__PACKAGE__->add_unique_constraint("phylonodeprop_pkey", ["phylonodeprop_id"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RNfofTOYPw5VrupJZVbYRA
